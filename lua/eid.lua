...
if EID then
    ...
    EID:addCollectible(Isaac.GetItemIdByName("The Real Left Hand"), "{{Chest}} On use, upgrades all chests in the room into a better counterpart. If there is nothing to upgrade, spawns a red chest.#Chest Order: {{SpikedChest}} > {{HauntedChest}} > {{Chest}} > {{RedChest}} > {{GoldenChest}} or {{StoneChest}} > {{WoodenChest}} or {{DirtyChest}} > {{HolyChest}} > {{MegaChest}}", "The Real Left Hand",  "en_us")
    ...
    EID:addCollectible(Isaac.GetItemIdByName("Boxing Glove"), "{{Chargeable}} Gain a charged punching attack that scales with your tearrate#{{Confusion}} The punch has high knockback and stuns enemies", "Boxing Glove",  "en_us")
    ...
    EID:addCollectible( Isaac.GetItemIdByName("Johnny's Knives"), "{{Throwable}} Throwable#Gain two homing flying knife familiars that do damage on contact", "Johnny's Knives",  "en_us")
    ...
    EID:addCollectible( Isaac.GetItemIdByName("Johnny's Knives"), "{{Throwable}} Бросаемое#Получите два самонаводящихся ножа с контактным уроном", "Ножи джонни",  "ru")
