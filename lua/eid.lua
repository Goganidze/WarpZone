...
if EID then
    ...
    EID:addCollectible(Isaac.GetItemIdByName("Tony"), "{{ArrowUp}}Taking damage activates berserk mode, and you start using your knuckles#{{ArrowUp}}Knuckles instakill enemies with less than 100 hp, and deals 5x your damage to enemies with more than 100 hp#Duration of effect is 160 frames and can be changed in dss", "Tony",  "en_us")
