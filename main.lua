...
if EID then
    ...
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_BIRTHDAY_CAKE, "{{Heart}} +1 HP#A random consumable and pickups of each type now spawn at the start of a floor#When the player holds Binge Eater,{{Speed}} -0.03 Speed and {{Tears}} +.5 Tears", "Birthday Cake", "en_us")
    ...
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_IS_YOU, "#Point the reticle at an obstacle to use an active item effect that corresponds to it#Rock - Mom's Bracelet {{Collectible[604]}}#Pot/Fool's Gold - Wooden Nickel {{Collectible[349]}}#Poop - The Poop {{Collectible[36]}}", "Is You",  "en_us")
    ...
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_DIOGENES_POT, "Toggles a melee hammer strike on and off#When equipped, you receive a {{Damage}} 1.5x damage multiplier#{{Card[1]}} Getting hit while equipped teleports you to the starting room", "Diogenes's Pot",  "en_us")
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_DIOGENES_POT_LIVE, "Toggles a melee hammer strike on and off#When equipped, you receive a {{Damage}} 1.5x damage multiplier#{{Card[1]}} Getting hit while equipped teleports you to the starting room", "Diogenes's Pot",  "en_us")
    ...
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_REAL_LEFT, "On use, upgrades all chests in the room into a better counterpart#Chest Order: Mimic -> Haunted -> Grey -> Red -> Golden or Stone -> Wooden or Old -> Eternal -> Mega", "The Real Left Hand",  "en_us")
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_HITOPS, "{{ArrowUp}} 0.2 Speed Up#This speed up can exceed the speed cap", "Hitops",  "en_us")
    ...
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_JOHNNYS_KNIVES, "Gain two homing flying knife familiars that do damage on contact#When killing enemies with the knives, spawn a pool of red creep that damages enemies. The size of the creep depends on the enemy's mass.#When enemy is killed by knives, gain +0.61 Tears to the rest of the room.", "Johnny's Knives",  "en_us")
