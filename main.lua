...
if EID then
    ...
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_BIRTHDAY_CAKE, "{{Heart}} +1 HP#A random consumable and pickups of each type now spawn at the start of a floor#When the player holds Binge Eater, -.03 Speed and +.5 Tears", "Birthday Cake", "en_us")
    ...
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_GREED_BUTT, "#When hit by an enemy or projectile , you fart, launching a coin out of your butt#There is a 5% chance that you drop a gold poop instead", "Greed Butt", "en_us")
    ...
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_GEORGE, "{{Range} 2.4 Range Up#When entering most special rooms, a red room will unlock across from you", "George",  "en_us")
    ...
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_TONY, "{{Damage} 1.7 Damage Multiplier#{{ArrowUp}} +1 Damage Up#{{ArrowDown}} When any item is taken, the buff and multiplier are both reduced by 0.1#This item's minimum damage multiplier is 1, it cannot decrease damage", "Tony",  "en_us")
    EID:addCollectible(WarpZone.WarpZoneTypes.COLLECTIBLE_REAL_LEFT, "On use, upgradess all chests in the room into a better counterpart#Chest Order: Mimic -> Haunted -> Grey -> Red -> Golden or Stone -> Wooden or Old -> Eternal -> Mega", "The Real Left Hand",  "en_us")
